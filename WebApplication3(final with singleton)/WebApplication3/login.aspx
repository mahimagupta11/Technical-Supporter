<%@ Page Title="" Language="C#" MasterPageFile="~/HomePage.Master" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="WebApplication3.WebForm4" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="divCenter">
       <div>
                ...
                <center><h3><asp:Label ID="Label1" runat="server" Text="Employee Login" Font-Size="Larger"></asp:Label></h3></center>
                <br />
